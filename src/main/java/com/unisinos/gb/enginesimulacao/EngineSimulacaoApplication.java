...
import com.unisinos.gb.enginesimulacao.model.process.*;
...
public class EngineSimulacaoApplication {
    ...
    public static void main(String[] args) {
        ...
        var filaBanheiro = new EntitySet(de.generateId(), "BANHEIRO  ", QueueModeEnum.FIFO, 100);
        ...
        criaProcessosNoTempoZero(atendimentoCaixa1, atendimentoCaixa2, sentarMesa, sentarBalcao, prepararComida1, prepararComida2, prepararComida3, usarBanheiroCaixa1, usarBanheiroCaixa2);
